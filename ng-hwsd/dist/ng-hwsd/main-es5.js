...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(route, routeName) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          this.routeName.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]) {
              _this.activedRoute = event.url;
              _this.ifRecommend = _this.activedRoute === '/' || _this.activedRoute.includes('recommend') ? true : false;

              if (_this.ifRecommend) {
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, 'scroll').subscribe(function () {
            if (_this.ifRecommend) {
              _this.WindowScroll();
